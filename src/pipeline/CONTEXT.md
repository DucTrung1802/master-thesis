...
(`feature_selection/CONTEXT.md` §14b), 199 of 203 channels were chosen by exactly one
...
| `final_features` | `return_5day__final__d20_h5` — 4,235 × 207 | `rank_5day__final__d20_h5` — 53,921 × 14 |
| `train_test_creator` | 2,918 / 610 / 635 × 20 × 202 | 26,964 / 12,524 / 13,028 × 20 × 9 |
| `model` | `lstm__vcb__return_5day__final__d20_h5` | `lstm__bank__rank_5day__final__d20_h5` |
| `result_evaluator` | series grain — **no skill** | panel grain — **no skill** |

30/30 runs scored. Both new runs stop at best epoch 1 and sit inside their own null.

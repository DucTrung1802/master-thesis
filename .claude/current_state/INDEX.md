...
| [data-state.md](../findings/data-state.md) | **11.6k** | asking what the DATA looks like today. §6-2-§6-3 — the `pool__ta` prune, the 2026-08-23 re-scrape and carry-up, the freshness distribution, `DEP-1`, the filings/OCR summary, **MSN 2026-09-07 (the gaps were REFUSALS: `JVW-2` and `MSO-5` fixed, `PBT-1`/`SPN-2`/`BSP-1` open)**, the audit |

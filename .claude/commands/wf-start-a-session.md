---
description: Orient in this repo before trusting anything: what is stale, what is broken, which ONE file to open.
---

Run the workflow in [`../workflows/start-a-session.md`](../workflows/start-a-session.md), start to finish.

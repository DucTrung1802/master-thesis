...
> Written 2026-08-16 against [selector.py](../../src/feature_selection/selector.py), [ranker_eval.py](../../src/feature_selection/ranker_eval.py)
> and the 21 run folders in `reports/feature_selection/`. Depth behind
> [CONTEXT.md](../context/feature_selection.md) §4 and §19, and behind the one-line entry in CLAUDE.md §4.
>
...
§4 of [CONTEXT.md](../context/feature_selection.md) has listed the six since 2026-08-03 with a column headed
...
CLAUDE.md §2 says it does not, and §6b of [CONTEXT.md](../context/feature_selection.md) measured a positive
...
So the blend gave **one model 2 of 6 votes**. §4 of [CONTEXT.md](../context/feature_selection.md) already said
...
of [CONTEXT.md](../context/feature_selection.md) had already measured that its GPU path is **4–8× SLOWER** than
...
[ranker_eval.py](../../src/feature_selection/ranker_eval.py) with tests instead of in a scratchpad script.

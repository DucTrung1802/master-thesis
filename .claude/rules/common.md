...
> nobody reads.**
>
> ⚠️ **This file is in the always-loaded budget** — `CLAUDE.md` (9.9k) + `../current_state/INDEX.md`
> (4.8k) + this (1.4k) = **14.6k**, re-measured 2026-09-06 and down from 165.7k. Keep it to rules: a

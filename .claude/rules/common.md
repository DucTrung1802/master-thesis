...
> nobody reads.**
>
> ⚠️ **This file is in the always-loaded budget** — `CLAUDE.md` (14.3k) + `../current_state/INDEX.md`
> (4.8k) + this (1.4k) = **20.5k**, re-measured 2026-09-13 — ⚠️ **the hub grew 11.9k -> 14.3k IN ONE DAY while never breaking the 300-line cap**, because R2 counts LINES and a line has no length limit. The cap is holding the shape and not the cost; `state_check.py`'s token check is what caught it and down from 165.7k. Keep it to rules: a

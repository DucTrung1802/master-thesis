...
- **126 of 181 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `thailand__economy__money__economics__thlps`, `close_adjust`, `thailand__economy__money__economics__thcbbs`, `drv_amihud_63`, `thailand__economy__money__economics__thm2`, `thailand__economy__gdp__economics__thgdpc`, `thailand__economy__business__economics__thlei`, `high`, `thailand__economy__money__economics__thfer`, `thailand__economy__trade__economics__thexp`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.0050 | +0.1801 |
| `ic_trend_per_fold` | -0.0289 | -0.0822 |

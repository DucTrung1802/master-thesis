...
- **126 of 186 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `russia__economy__money__economics__rulps`, `russia__economy__labor__economics__ruwm`, `russia__economy__consumer__economics__rupsc`, `russia__economy__government__economics__rugd`, `close_raw`, `drv_vwap_raw`, `close_adjust`, `open`, `drv_amihud_21`, `russia__economy__government__economics__runwfla`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.0909 | +0.1517 |
| `ic_trend_per_fold` | +0.0330 | -0.0861 |

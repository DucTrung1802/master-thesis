...
- **112 of 176 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `singapore__economy__trade__economics__sged`, `close_adjust`, `singapore__economy__prices__economics__sgccp`, `drv_amihud_21`, `singapore__economy__money__economics__sgm1`, `singapore__economy__prices__economics__sgcpi`, `singapore__economy__money__economics__sgm2`, `singapore__economy__money__economics__sgbbs`, `singapore__economy__gdp__economics__sggdpu`, `singapore__economy__gdp__economics__sggdpt`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.1104 | +0.1542 |
| `ic_trend_per_fold` | -0.0623 | -0.1472 |

...
- **115 of 170 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `malaysia__economy__money__economics__mylps`, `malaysia__economy__money__economics__mym1`, `close_raw`, `drv_amihud_21`, `close_adjust`, `malaysia__economy__money__economics__mym3`, `malaysia__economy__trade__economics__myed`, `malaysia__economy__consumer__economics__mycs`, `malaysia__economy__prices__economics__mycpi`, `n_sell_orders`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.0493 | +0.2119 |
| `ic_trend_per_fold` | +0.0119 | -0.0367 |

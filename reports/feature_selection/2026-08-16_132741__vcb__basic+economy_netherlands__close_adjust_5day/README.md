...
- **132 of 211 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `netherlands__economy__money__economics__nlm0`, `drv_amihud_21`, `netherlands__economy__trade__economics__nlngi`, `netherlands__economy__money__economics__nlm3`, `netherlands__economy__consumer__economics__nlhdg`, `netherlands__economy__prices__economics__nlcpit`, `netherlands__economy__labor__economics__nlemp`, `netherlands__economy__trade__economics__nlexp`, `netherlands__economy__labor__economics__nlyur`, `netherlands__economy__trade__economics__nlbot`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.2562 | +0.2548 |
| `ic_trend_per_fold` | -0.0192 | -0.1525 |

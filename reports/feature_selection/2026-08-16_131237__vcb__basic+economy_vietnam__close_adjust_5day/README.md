...
- **85 of 140 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `vietnam__economy__trade__economics__vnexp`, `vietnam__economy__money__economics__vnfer`, `vietnam__economy__prices__economics__vncpi`, `close_raw`, `vietnam__economy__trade__economics__vncop`, `n_sell_orders`, `avg_vol_per_buy_order`, `close_adjust`, `drv_amihud_63`, `open`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | -0.0907 | +0.1151 |
| `ic_trend_per_fold` | -0.0129 | -0.0448 |

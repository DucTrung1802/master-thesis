...
- **111 of 175 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `philippines__economy__money__economics__phm0`, `close_raw`, `philippines__economy__government__economics__phfe`, `philippines__economy__money__economics__phm3`, `philippines__economy__trade__economics__phrem`, `philippines__economy__prices__economics__phcpi`, `philippines__economy__consumer__economics__phccr`, `drv_amihud_21`, `philippines__economy__government__economics__phgr`, `philippines__economy__money__economics__phbbs`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | -0.1136 | -0.0174 |
| `ic_trend_per_fold` | +0.0082 | -0.0371 |

...
- **159 of 253 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `japan__economy__money__fred__nikkei225`, `japan__economy__money__economics__jplps`, `japan__economy__labor__economics__jpfte`, `japan__economy__housing__economics__jphpi`, `japan__economy__labor__fred__lfwa64ttjpm647s`, `japan__economy__labor__economics__jpmw`, `japan__economy__money__economics__jpm1`, `japan__economy__labor__economics__jpemp`, `n_buy_orders`, `japan__economy__labor__economics__jpyur`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.0140 | +0.0269 |
| `ic_trend_per_fold` | -0.0530 | -0.1802 |

...
- **164 of 255 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `united_kingdom__economy__money__economics__gbm0`, `united_kingdom__economy__money__economics__gbfer`, `united_kingdom__economy__money__economics__gbcbbs`, `united_kingdom__economy__government__economics__gbfe`, `united_kingdom__economy__prices__fred__gbrcpiallminmei`, `drv_amihud_21`, `drv_vwap_raw`, `united_kingdom__economy__trade__economics__gbed`, `united_kingdom__economy__government__economics__gbgd`, `united_kingdom__economy__prices__economics__gbcppi`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | -0.0972 | +0.1046 |
| `ic_trend_per_fold` | +0.1187 | -0.1526 |

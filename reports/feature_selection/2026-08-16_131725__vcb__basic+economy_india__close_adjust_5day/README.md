...
- **top 10 by ensemble rank**: `india__economy__money__economics__infer`, `close_raw`, `india__economy__trade__economics__ingres`, `india__economy__prices__economics__inppi`, `india__economy__trade__economics__incop`, `india__economy__money__economics__inm1`, `drv_amihud_21`, `open`, `india__economy__business__economics__inelp`, `india__economy__money__economics__inm2`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.1336 | +0.1712 |
| `ic_trend_per_fold` | -0.0113 | -0.1231 |

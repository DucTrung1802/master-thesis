...
- **143 of 245 channels kept** after the |rho| >= 0.9 redundancy prune
- **top 10 by ensemble rank**: `germany__economy__money__economics__dem3`, `germany__economy__labor__economics__delc`, `close_adjust`, `germany__economy__money__economics__dem1`, `germany__economy__prices__economics__decpihu`, `drv_amihud_21`, `germany__economy__trade__economics__decop`, `germany__economy__money__economics__defer`, `drv_amihud_63`, `germany__economy__gdp__fred__clvmnacscab1gqde`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | -0.0651 | +0.1933 |
| `ic_trend_per_fold` | -0.0278 | +0.0258 |

...
**Best on val:** `ensemble_geo3` — val AUC 0.799, **test AUC 0.660** against a block-shuffled null p95 of 0.644 (max 0.795, z 1.84); test PR-AUC 0.104 on a base rate of 0.051; of the 99 test sessions over the val threshold, 0.081 were followed by the event. Refitted on train+val, its test AUC is 0.659 (null p95 0.641).

...
*Generated 2026-08-10T14:42:20.870176+00:00 at commit `7e925a52+dirty`.*
...
- **top 10 by ensemble rank**: `japan__economy__labor__economics__jpmw`, `japan__economy__labor__economics__jpwag`, `japan__economy__consumer__economics__jpblr`, `japan__economy__housing__economics__jphpi`, `japan__economy__business__economics__jpcep`, `japan__economy__prices__fred__fpcpitotlzgjpn`, `japan__economy__prices__economics__jptccpi`, `foreign_own`, `japan__economy__labor__economics__jpup`, `japan__economy__business__economics__jpcap`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.0536 | +0.0813 |
| `ic_trend_per_fold` | -0.0150 | -0.0087 |
| `hit_rate` | +0.4828 | +0.4900 |
| `n_eff_per_fold` | 148.6 | 148.6 |

## The bar

- observed **+0.0536** against a p95 bar of **+0.0426** (20 draws) — **CLEARS**
- null mean -0.0005, sd 0.0379, max +0.0916; z = **+1.43**, p = 0.0952

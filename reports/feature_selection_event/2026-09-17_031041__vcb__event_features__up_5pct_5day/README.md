...
- **top 10 by ensemble rank**: `har_lpk_22`, `cal_days_since_tet`, `har_semi_dn_22`, `flow_fnet_20`, `sec_rate_up_60`, `flow_fnet_5`, `har_lpk_10`, `har_lpk_63`, `evt_vol_ratio_20_120`, `evt_vol_10`

| metric | selected | all channels |
|---|---|---|
| `ic_mean` | +0.1126 | +0.1088 |
| `ic_trend_per_fold` | +0.0042 | +0.0062 |
| `hit_rate` | — | — |
| `n_eff_per_fold` | 99.0 | 99.0 |

## The bar

- observed **+0.1126** against a p95 bar of **+0.0354** (10 draws) — **CLEARS**
- null mean -0.0008, sd 0.0240, max +0.0439; z = **+4.73**, p = 0.0909

## Holdout

| feature set | labels | IC | hit rate |
|---|---|---|---|
| selected | real | +0.1102 | — |
| selected | shuffled control | +0.0254 | — |
| all channels | real | +0.0721 | — |
| all channels | shuffled control | -0.0437 | — |

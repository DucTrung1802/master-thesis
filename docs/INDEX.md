...
>
> ⚠️ **NEVER BULK-LOAD THIS CORPUS.** 127 `.md` files, **~639k tokens** — about 3× a full context
...
|---|---|---|
| [../src/web_scraper/CONTEXT.md](../src/web_scraper/CONTEXT.md) | **59.9k** | touching a scraper, the PDF/OCR statement parser, or `raw_data/` layout |

...
|---|---|---|
| [../CLAUDE.md](../CLAUDE.md) | **68.3k** | *what is this project, and what has it PROVED?* The map and the verdict. §2 is the headline negative, §6 the current state |

...
| **P40** | **BID IS 170 / 171 FROM 2012 — one cell left, Q4-2016** | ~2 h | ✅ | — | ✅ **Q1-2012, Q3-2015, Q1-2026 and 6 of the 7 `fx not mapped` quarters all recovered 2026-08-27.** Balance sheet **57/57**, income statement **57/57**, cash flow **56/57**. ⚠️ **SIX OF THE SEVEN WERE NEVER AN FX PROBLEM** — four won at plain `onnx@200` once `PGB-1`'s `_anchor` seam split existed; nobody had re-run them. **A cascade's final refusal names the hardest path tried, not the blocking defect.** ⚠️ **Q4-2016 IS REVERTED TO `missing` BECAUSE ITS PARSED VALUE WAS WRONG** — closing 61,575,636 against the filing's printed **65,521,789**, accepted by both gates with an identity residual of exactly +1e12. **The correct figure is known, so this is a verification task, not a discovery one.** **↓ detail block**; CLAUDE.md §6-2-duovicies |

...
| weights | equal, `1/k` | ⚠️ never varied — TODO `P11` |
...
| [TODO.md](TODO.md) | ⚠️ **renumbered 2026-08-23 — the first two items CLOSED, so every code moved down by 2.** `FRZ-1` (the output blocker) and the gold carry-up are **done**; today's `P1` is `STA-1`, and `P4`-`P7` are the fundamentals program (the JSON gate, then OCR on Kaggle), `P8` (live scoring), `P9` (the `FNM-1` fix), `P11` (portfolio construction), `P12` (execution realism) |

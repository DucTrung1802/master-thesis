...
> [src/orchestration/todo.md](../../src/orchestration/todo.md) · mã và kết quả trong
...
| | lý do |
|---|---|
| **Fine-tune bộ chấm sentiment tiếng Việt** | Mục 7–13 của todo.md bị **dừng có chủ đích** sau khi nhóm A cho kết quả null ở nơi độ phủ cao nhất. Bước đầu tiên và rẻ nhất (publication effect) đã trắng. |
...
| | |
|---|---|
| ⚠️ **`close_adjust` sai ở corporate action** | 1.002 dòng; cần data-quality screen ở **bronze**, cạnh 262 dòng `high < low` (todo.md mục 25) |
...
| **Tài liệu** | [`CONTEXT.md`](CONTEXT.md) (23 paper) · [`guidance.md`](guidance.md) (kế hoạch) · [`todo.md`](../../src/orchestration/todo.md) (nhật ký) · file này |
